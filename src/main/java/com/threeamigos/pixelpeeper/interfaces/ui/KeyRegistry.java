...
public enum KeyRegistry implements HintsProducer<String> {
	...
	OPEN_DRAG_AND_DROP_PANEL_KEY(KeyEvent.VK_D, "D",
	...
	MOVE_ALL_IMAGES_KEY(KeyEvent.VK_I, "I",
	...
	SHOW_EDGES_DETETECTOR_PARAMETERS_KEY(KeyEvent.VK_P, "P",
	...
	SHOW_POSITION_MINIATURE_KEY(KeyEvent.VK_S, "S",
	...
	SHOW_TAGS_OVERRIDING_PREFERENCES_KEY(KeyEvent.VK_V, "V",
	...
	ANNOTATE_KEY(KeyEvent.VK_SHIFT, "Shift",

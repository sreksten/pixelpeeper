 ...
 * or a later time.<br/>
 * It needs a pointer to the MainWindow to ask it for certain menus. It also can register as a
 * listener on some properties or preferences to update its menus when needed.
 *
...
public interface MainWindowPlugin {
    ...
    /**
     * @param mainWindow a reference to the MainWindow object, to ask it one or more menus to work with
     */

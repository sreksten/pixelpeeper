...
abstract class PaletteFilterPreferencesImpl extends BasicPropertyChangeAware
    ...
    public void setSaturationThreshold(int saturationThreshold) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_SATURATION_THRESHOLD_CHANGED, oldSaturationThreshold,
                saturationThreshold);
    }
    ...
    public void setLightnessMinThreshold(int lightnessMinThreshold) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_LIGHTNESS_MIN_THRESHOLD_CHANGED, oldLightnessMinThreshold,
    ...
    public void setLightnessMaxThreshold(int lightnessMaxThreshold) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_LIGHTNESS_MAX_THRESHOLD_CHANGED, oldLightnessMaxThreshold,
    ...
    public void setHueWeight(double hueWeight) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_HUE_WEIGHT_CHANGED, oldHueWeight, hueWeight);
    }
    ...
    public void setSaturationWeight(double saturationWeight) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_SATURATION_WEIGHT_CHANGED, oldSaturationWeight,
                saturationWeight);
    }
    ...
    public void setLightnessWeight(double lightnessWeight) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_LIGHTNESS_WEIGHT_CHANGED, oldLightnessWeight,
                lightnessWeight);
    }
    ...
    public void setSkinTonesMappingEnabled(boolean skinTonesMappingEnabled) {
        ...
        firePropertyChange(CommunicationMessages.PALETTE_FILTER_SKIN_TONES_MAPPING_CHANGED,

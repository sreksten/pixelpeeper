...
public class ZXSpectrumEdgesDetectorPreferencesSelectorImpl extends AbstractEdgesDetectorPreferencesSelectorImpl {
    ...
    public ZXSpectrumEdgesDetectorPreferencesSelectorImpl(EdgesDetectorPreferences edgesDetectorPreferences,
        ...
        preferencesSelectorDataModel = new ZXSpectrumEdgesDetectorPreferencesSelectorDataModel(dataModel,
                edgesDetectorPreferences, zxSpectrumEdgesDetectorPreferences, testImageCanvas);
    ...
    JPanel createFlavourPanel(Component component) {
        ...
        ZXSpectrumEdgesDetectorPreferencesSelectorDataModel downcastDatamodel =
                (ZXSpectrumEdgesDetectorPreferencesSelectorDataModel) preferencesSelectorDataModel;

...
public class C64FilterPreferencesSelectorImpl extends AbstractFilterPreferencesSelectorImpl {
    ...
    public C64FilterPreferencesSelectorImpl(FilterPreferences filterPreferences,
                                            C64PaletteFilterPreferences c64EdgesDetectorPreferences,
        ...
        preferencesSelectorDataModel = new C64PaletteFilterPreferencesSelectorDataModel(dataModel,
                filterPreferences, c64EdgesDetectorPreferences, testImageCanvas);
    ...
    JPanel createFlavorPanel(Component component) {
        ...
        C64PaletteFilterPreferencesSelectorDataModel downcastDatamodel =
                (C64PaletteFilterPreferencesSelectorDataModel) preferencesSelectorDataModel;

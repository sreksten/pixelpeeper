...
import com.threeamigos.pixelpeeper.implementations.datamodel.imagereaders.CompositeImageReader;
...
public class ImageReaderFactoryImpl implements ImageReaderFactory {
    ...
    public ImageReader getImageReader() {
        ...
        return new CompositeImageReader(imageHandlingPreferences);

...
public class TextFileCannyEdgesDetectorPreferencesPersister extends TextFilePersister<CannyEdgesDetectorPreferences>
	...
	public TextFileCannyEdgesDetectorPreferencesPersister(RootPathProvider rootPathProvider,
	...
	@Override
	protected void save(PrintWriter writer, CannyEdgesDetectorPreferences cannyEdgesDetectorPreferences)
			throws IOException {

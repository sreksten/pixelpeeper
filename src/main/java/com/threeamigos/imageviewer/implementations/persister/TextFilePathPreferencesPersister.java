...
public class TextFilePathPreferencesPersister extends TextFilePersister<PathPreferences>
	...
	public TextFilePathPreferencesPersister(RootPathProvider rootPathProvider, ExceptionHandler exceptionHandler) {
	...
	@Override
	protected void save(PrintWriter writer, PathPreferences pathPreferences) throws IOException {

...
public class FileBasedEdgesDetectorPreferencesPersister extends
		FileBasedAbstractPreferencesPersister<EdgesDetectorPreferences> implements Persister<EdgesDetectorPreferences> {
	...
	public FileBasedEdgesDetectorPreferencesPersister(PreferencesRootPathProvider rootPathProvider,
	...
	@Override
	protected void loadImpl(BufferedReader reader, EdgesDetectorPreferences edgesDetectorPreferences)
	...
	@Override
	protected void saveImpl(PrintWriter writer, EdgesDetectorPreferences edgesDetectorPreferences) throws IOException {

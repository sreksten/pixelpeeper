...
public class TextFileExifTagPreferencesPersister extends TextFilePersister<ExifTagPreferences>
	...
	public TextFileExifTagPreferencesPersister(RootPathProvider rootPathProvider, ExceptionHandler exceptionHandler) {
	...
	@Override
	protected void save(PrintWriter writer, ExifTagPreferences exifTagPreferences) throws IOException {

...
public class FileBasedRomyJonaEdgesDetectorPreferencesPersister
		extends FileBasedAbstractPreferencesPersister<RomyJonaEdgesDetectorPreferences>
		implements Persister<RomyJonaEdgesDetectorPreferences> {
	...
	public FileBasedRomyJonaEdgesDetectorPreferencesPersister(PreferencesRootPathProvider rootPathProvider,
	...
	@Override
	protected void loadImpl(BufferedReader reader, RomyJonaEdgesDetectorPreferences romyJonaEdgesDetectorPreferences)
	...
	@Override
	protected void saveImpl(PrintWriter writer, RomyJonaEdgesDetectorPreferences romyJonaEdgesDetectorPreferences)
			throws IOException {
